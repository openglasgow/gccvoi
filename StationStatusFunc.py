...
def get_station_status(station_status_url: str,
...
def run_station_status():
    token = get_access_token(TOKEN_URL, API_KEY)

    station_status_df = get_station_status(
    ...
    with connect as connect:
        ...
        BEGIN              
            ...
            CONSTRAINT fk_station_info_to_status
